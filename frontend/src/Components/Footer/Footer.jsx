...
export default function LargeWithNewsletter() {
  return (
    <Box
    marginTop={'20px'}
      bg={useColorModeValue('#232E58', 'gray.900')}
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid
          ...
          <Stack spacing={6} bg={''}>
            <Box>
              <Image src='http://localhost:3000/static/media/DRlogo.d4b29fa06e553453cfab.png' width={'30%'}/>
            </Box>
            <Text fontSize={'sm'}>
              © Dr. Hiba Saadeh. All rights reserved
            </Text>
            <Stack direction={'row'} spacing={6}>
              ...
              <SocialButton label={'Instagram'} href={'https://www.instagram.com/dr.hibasaadeh/?utm_medium=copy_link'}>
                <FaInstagram />
              </SocialButton>
            </Stack>
          </Stack>
          <Stack align={''} bg=''>
            ...
            <Link to='/about'><Text color="white">About us</Text></Link>
            <Link to='/contact'><Text to={'#'} color="white">Contact us</Text></Link>
          </Stack>
          <Stack align={''} >
            <Heading color="white" textAlign={'center'} size={'md'}>Get In Touch</Heading>
            <Box  bg=''>
                    <VStack pl={0} spacing={3} alignItems="" bg=''>
                      <Button
                        size="md"
                        height="48px"
                        width="200px"
