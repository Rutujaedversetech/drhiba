import {
  ...
  export default function PatientdetailsReducer(
    ...
    switch (type) {
      case GET_ALL_SLOTHOLIDAY_REQUEST:
        return {
          ...state,
      ...
      case GET_ALL_SLOTHOLIDAY_SUCCESS:
        return {
          ...state,
          AllProducts: { loading: false, error: false },
          AddProduct: { loading: false, error: false ,message:''},
      ...
      case GET_ALL_SLOTHOLIDAY_FAILURE:
        return {
          ...state,
      ...
      case ADD_SLOTHOLIDAY_REQUEST:
        return {
          ...state,
          DeleteProduct: { loading: false, error: true,message:'' },

          AddProduct: { loading: true, error: false,message:'' },         };
      case ADD_SLOTHOLIDAY_SUCCESS:
      ...
      case DELETE_SLOTHOLIDAY_REQUEST:
        return {
          ...state,
          AddProduct: { loading: false, error: false,message:''  },

          DeleteProduct: { loading: true, error: false },        };
      case DELETE_SLOTHOLIDAY_SUCCESS:
        return {
          ...state,
      ...
      case DELETE_SLOTHOLIDAY_FAILURE:
        return {
          ...state,
