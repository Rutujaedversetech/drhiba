import {
  ...
  export default function PatientdetailsReducer(
    ...
    switch (type) {
      case GET_ALL_SERVICEDETAILS_REQUEST:
        return {
          ...state,
      ...
      case GET_ALL_SERVICEDETAILS_SUCCESS:
        return {
          ...state,
          AllProducts: { loading: false, error: false },
          AddProduct: { loading: false, error: false ,message:''},
      ...
      case GET_ALL_SERVICEDETAILS_FAILURE:
        return {
          ...state,
      ...
      case ADD_SERVICEDETAILS_REQUEST:
        return {
          ...state,
          AddProduct: { loading: true, error: false,message:'' },
        };
      case ADD_SERVICEDETAILS_SUCCESS:
      ...
      case ADD_SERVICEDETAILS_FAILURE:
        return {
          ...state,
          AddProduct: { loading: false, error: true,message:'' },
        };
      ...
      case DELETE_SERVICEDETAILS_REQUEST:
        return {
          ...state,
          DeleteProduct: { loading: true, error: false,message:"" },
        };
      case DELETE_SERVICEDETAILS_SUCCESS:
        return {
          ...state,
      ...
      case DELETE_SERVICEDETAILS_FAILURE:
        return {
          ...state,
