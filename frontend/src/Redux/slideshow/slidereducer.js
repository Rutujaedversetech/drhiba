import {
  ...
  export default function PatientdetailsReducer(
    ...
    switch (type) {
      case GET_ALL_SLIDEIMAGE_REQUEST:
        return {
          ...state,
      ...
      case GET_ALL_SLIDEIMAGE_SUCCESS:
        return {
          ...state,
          AllProducts: { loading: false, error: false },
          AddProduct: { loading: false, error: false ,message:''},
      ...
      case GET_ALL_SLIDEIMAGE_FAILURE:
        return {
          ...state,
      ...
      case ADD_SLIDEIMAGE_SUCCESS:
        ...
        return {
          ...
          AddProduct: { loading: false, error: false,message:'slide added'  },
         // DeleteProduct: { loading: false, error: true,message:'' },

          data: [...state.data,payload],
        };
  
      case ADD_SLIDEIMAGE_FAILURE:
        return {
          ...state,
          AllProducts: { loading: false, error: false },
      ...
      case DELETE_SLIDEIMAGE_REQUEST:
        return {
          ...state,
          AddProduct: { loading: false, error: false,message:''  },
      ...
      case DELETE_SLIDEIMAGE_SUCCESS:
        return {
          ...state,
          DeleteProduct: { loading: false, error: false,message:'slide deleted' },
          AddProduct: { loading: false, error: false,message:''  },

          data: state.data.filter((item) => item._id !== payload),
        };
  
      case DELETE_SLIDEIMAGE_FAILURE:
        return {
          ...state,
          DeleteProduct: { loading: false, error: true,message:'' },
        };
