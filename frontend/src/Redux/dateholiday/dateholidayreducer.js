import {
  ...
  export default function PatientdetailsReducer(
    ...
    switch (type) {
      case GET_ALL_DATEHOLIDAY_REQUEST:
        return {
          ...state,
      ...
      case GET_ALL_DATEHOLIDAY_SUCCESS:
        return {
          ...state,
          AllProducts: { loading: false, error: false },
          AddProduct: { loading: false, error: false ,message:''},
      ...
      case GET_ALL_DATEHOLIDAY_FAILURE:
        return {
          ...state,
      ...
      case ADD_DATEHOLIDAY_REQUEST:
        return {
          ...state,
          DeleteProduct: { loading: false, error: true,message:'' },

          AddProduct: { loading: true, error: false,message:'' },          };
      case ADD_DATEHOLIDAY_SUCCESS:
      ...
      case DELETE_DATEHOLIDAY_REQUEST:
        return {
          ...state,
          AddProduct: { loading: false, error: false,message:''  },

          DeleteProduct: { loading: true, error: false,message:"" },        };
      case DELETE_DATEHOLIDAY_SUCCESS:
        return {
          ...state,
      ...
      case DELETE_DATEHOLIDAY_FAILURE:
        return {
          ...state,
